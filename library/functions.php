...
function buildImageDisplay($imageArray) {
    ...
    foreach ($imageArray as $image) {
     $id .= '<li class="vehicle-card no-dot">';
     $id .= "<img class='vehicle-img img-box' src='$image[imgPath]' title='$image[invMake] $image[invModel] image on PHP Motors.com' alt='$image[invMake] $image[invModel] image on PHP Motors.com'>";
